...
const ReadBooks = () => {
  ...
  return (
    <div>
      ...
      <div className='bg-white rounded-2xl border border-red-500 shadow-md p-4 flex gap-6 flex-row'>
        <div className='bg-[#1313130D] p-6 flex justify-center items-center size-[230px] rounded-2xl'>
          <img
            src={"https://i.ibb.co/qDLsFQJ/8.png"}
            className='w-full h-full '
          />
        </div>
        <div>
          <h2 className='text-2xl font-bold text-[#131313]'>hfjee</h2>
          ...
          <div className='bg-white flex gap-3 items-center'>
            ...
            <div className='flex flex-row gap-2'>
              ...
              <p>
                Year of Publishing: <span>1924</span>{" "}
              </p>
            </div>
          </div>
